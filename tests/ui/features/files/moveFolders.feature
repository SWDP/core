Feature: moveFolders
	...
	Scenario: move a folder into an other folder
	...
	Scenario: move a folder into an other folder where a folder with the same name already exists
		When I create a folder with the name "sub-folder"
		And I move the folder "sub-folder" into the folder "simple-folder"
		Then notifications should be displayed with the text
			|Could not move "sub-folder", target exists|
		And the folder "sub-folder" should be listed
	...
	Scenario: Move multiple folders at once
		...
		But the moved elements should be listed in the in the folder "simple-empty-folder"

	Scenario: move a folder into an other folder (problematic characters)
